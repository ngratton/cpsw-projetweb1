    ...
    <div class="conteneur">
        ...
        <main>
            <div class="container flex-centre">
                <form action="./ajout-spectacle-submit.php" method="post" name="ajout-spectacle" enctype="multipart/form-data">
                                    ...
                                    <div class="flex">
                                        <div class="flex-2x1 admin-ajoutoeuvre-details">
                                            <label for="spectacle-titre">
                                                <span>Titre</span>
                                                <input type="text" name="spectacle-titre" id="spectacle-titre" required>
                                            </label>
                                            <label for="spectacle-date">
                                                <span>Date et heure</span>
                                                <input type="date" name="spectacle-date" id="spectacle-date" required>
                                                <input type="time" name="spectacle-heure" id="spectacle-heure" required>
                                            </label>
                                            <label for="spectacle-img">
                                                <span>Image du spectacle</span>
                                        ...
                                        <div class="flex-2x1 admin-ajoutoeuvre-details">
                                            <label for="spectacle-salle">
                                                <span>Salle</span>
                                                <input type="text" name="spectacle-salle" id="spectacle-salle" required>
                                            </label>
                                            <label for="spectacle-ville">
                                                <span>Ville</span>
                                                <input type="text" name="spectacle-ville" id="spectacle-ville" required>
                                            </label>
                                            </label>
                                            <label for="spectacle-billets">
                                                <span>Lien pour les billets</span>
                                                <input type="text" name="spectacle-billets" id="spectacle-billets" required>
                                            </label>
                                        </div>
                                    </div>
                                </div>
